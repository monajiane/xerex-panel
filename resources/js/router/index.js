...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'security/waf',          name: 'security.waf',          component: () => import('../views/WafRulesView.vue') },
            { path: 'security/ip-lists',     name: 'security.ip-lists',     component: () => import('../views/IpListsView.vue') },
            { path: 'security/rate-limits',  name: 'security.rate-limits',  component: () => import('../views/RateLimitsView.vue') },
        ],
    },
